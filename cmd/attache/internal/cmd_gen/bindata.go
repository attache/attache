...
func templatesRoutesJsonTpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/routes.json.tpl", size: 2080, mode: os.FileMode(420), modTime: time.Unix(1531805604, 0)}
...
func templatesRoutesTpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/routes.tpl", size: 2325, mode: os.FileMode(420), modTime: time.Unix(1531805604, 0)}
...
func templatesView_listTpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/view_list.tpl", size: 595, mode: os.FileMode(420), modTime: time.Unix(1531805604, 0)}
