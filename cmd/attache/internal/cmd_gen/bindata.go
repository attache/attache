...
func templatesModelTpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/model.tpl", size: 1407, mode: os.FileMode(420), modTime: time.Unix(1538381953, 0)}
...
func templatesRoutesJsonTpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/routes.json.tpl", size: 2117, mode: os.FileMode(420), modTime: time.Unix(1538381046, 0)}
...
func templatesRoutesTpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/routes.tpl", size: 2620, mode: os.FileMode(420), modTime: time.Unix(1538382234, 0)}
