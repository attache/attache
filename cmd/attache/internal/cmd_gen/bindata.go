...
// sources:
// templates/model.tpl (1.406kB)
// templates/routes.json.tpl (2.116kB)
// templates/routes.tpl (2.619kB)
// templates/view_create.tpl (705B)
// templates/view_list.tpl (865B)
// templates/view_update.tpl (895B)
...
func templatesModelTpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/model.tpl", size: 1406, mode: os.FileMode(0644), modTime: time.Unix(1606358908, 0)}
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0x24, 0xc7, 0x39, 0xc3, 0xa9, 0x50, 0xff, 0xa8, 0x8, 0x5d, 0x35, 0x56, 0xd5, 0x17, 0xf1, 0xe1, 0x9f, 0xed, 0xa4, 0x23, 0xba, 0x13, 0x96, 0x35, 0x59, 0x1f, 0x14, 0x5a, 0x2, 0xac, 0xdf, 0xed}}
	return a, nil
}
...
func templatesRoutesJsonTpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/routes.json.tpl", size: 2116, mode: os.FileMode(0644), modTime: time.Unix(1606358908, 0)}
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0xbc, 0x6c, 0x88, 0xed, 0x89, 0xca, 0x8f, 0x63, 0x94, 0xbb, 0x24, 0xa6, 0x31, 0x8e, 0xaa, 0x19, 0x4d, 0x1, 0x82, 0x7a, 0x41, 0x7c, 0xad, 0x8a, 0x9a, 0xd9, 0x42, 0x36, 0x6d, 0xe6, 0x4d, 0x7f}}
	return a, nil
}
...
func templatesRoutesTpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/routes.tpl", size: 2619, mode: os.FileMode(0644), modTime: time.Unix(1606358908, 0)}
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0xd6, 0xe, 0xf2, 0xa9, 0x23, 0x8e, 0x1c, 0x3a, 0x2f, 0x41, 0xae, 0x7, 0x4e, 0x2e, 0xcd, 0x45, 0x8b, 0x82, 0x8f, 0xc9, 0x73, 0x39, 0x8d, 0xb9, 0xba, 0x34, 0x72, 0x1b, 0xed, 0xa5, 0x99, 0x58}}
	return a, nil
}
...
func templatesView_createTpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/view_create.tpl", size: 705, mode: os.FileMode(0644), modTime: time.Unix(1606358908, 0)}
...
func templatesView_listTpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/view_list.tpl", size: 865, mode: os.FileMode(0644), modTime: time.Unix(1606358908, 0)}
...
func templatesView_updateTpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/view_update.tpl", size: 895, mode: os.FileMode(0644), modTime: time.Unix(1606358908, 0)}
...
var _bintree = &bintree{nil, map[string]*bintree{
	"templates": {nil, map[string]*bintree{
		"model.tpl": {templatesModelTpl, map[string]*bintree{}},
		"routes.json.tpl": {templatesRoutesJsonTpl, map[string]*bintree{}},
		"routes.tpl": {templatesRoutesTpl, map[string]*bintree{}},
		"view_create.tpl": {templatesView_createTpl, map[string]*bintree{}},
		"view_list.tpl": {templatesView_listTpl, map[string]*bintree{}},
		"view_update.tpl": {templatesView_updateTpl, map[string]*bintree{}},
	}},
}}
