...
func templatesModelTpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/model.tpl", size: 1614, mode: os.FileMode(420), modTime: time.Unix(1530469189, 0)}
...
func templatesRoutesTpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/routes.tpl", size: 2325, mode: os.FileMode(420), modTime: time.Unix(1530469632, 0)}
